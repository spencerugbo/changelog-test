...
---
## Release [v2.24.1](https//github.com/nginx/agent/releases/tag/v2.24.1)

---
## Release [v2.24.0](https//github.com/nginx/agent/releases/tag/v2.24.0)

### 🐛 Bug Fixes

In this release we have resolved the following issues:

- fix: uri and request parsing; by [@mohamed](https://github.com/mohamed)-gougam in [agent#222](https://github.com/nginx/agent/pull/222)
- fix docs to correct term by [@oliveromahony](https://github.com/oliveromahony) in [agent#242](https://github.com/nginx/agent/pull/242)
- fix: repair the app_protect_metadata by [@edarzins](https://github.com/edarzins) in [agent#243](https://github.com/nginx/agent/pull/243)
- Fix cache level size info for systems data by [@achawla2012](https://github.com/achawla2012) in [agent#238](https://github.com/nginx/agent/pull/238)
- Fix architecture and uname by [@achawla2012](https://github.com/achawla2012) in [agent#239](https://github.com/nginx/agent/pull/239)
- Fix OS release information in system details by [@achawla2012](https://github.com/achawla2012) in [agent#237](https://github.com/nginx/agent/pull/237)
- fix: made build target to work predictably by [@defanator](https://github.com/defanator) in [agent#247](https://github.com/nginx/agent/pull/247)
- fix: include proxy_ssl_certificate in the nginx config update by [@CodeMonkeyF5](https://github.com/CodeMonkeyF5) in [agent#254](https://github.com/nginx/agent/pull/254)
- Fix flaky install/uninstall test by [@Dean](https://github.com/Dean)-Coakley in [agent#260](https://github.com/nginx/agent/pull/260)

### 📝 Documentation

We have made the following updates to the documentation:

- Fix docs to reference packages in current release by [@Dean](https://github.com/Dean)-Coakley in [agent#219](https://github.com/nginx/agent/pull/219)
- Move extension plugins to the extensions folder by [@dhurley](https://github.com/dhurley) in [agent#183](https://github.com/nginx/agent/pull/183)
- deprecate-nginx-id-from-violation by [@mohamed](https://github.com/mohamed)-gougam in [agent#241](https://github.com/nginx/agent/pull/241)
- Update pull_request_template.md by [@oliveromahony](https://github.com/oliveromahony) in [agent#256](https://github.com/nginx/agent/pull/256)
- Add nginx cache and upstream metrics by [@aphralG](https://github.com/aphralG) in [agent#233](https://github.com/nginx/agent/pull/233)

### 🔨 Maintenance

We have made the following maintenance-related minor changes:

- Add assertion for no error level logs in tests by [@Dean](https://github.com/Dean)-Coakley in [agent#220](https://github.com/nginx/agent/pull/220)
- add upstream status metrics by [@aphralG](https://github.com/aphralG) in [agent#203](https://github.com/nginx/agent/pull/203)
- Print NginxConfig in JSON format for debug and trace levels by [@dareste](https://github.com/dareste) in [agent#210](https://github.com/nginx/agent/pull/210)
- Add plus upstream metrics by [@aphralG](https://github.com/aphralG) in [agent#214](https://github.com/nginx/agent/pull/214)
- Add almalinux support by [@Dean](https://github.com/Dean)-Coakley in [agent#212](https://github.com/nginx/agent/pull/212)
- Stop repeating error messages during metric collection by [@dhurley](https://github.com/dhurley) in [agent#225](https://github.com/nginx/agent/pull/225)
- Send agent version in grpc metadata by [@ryepup](https://github.com/ryepup) in [agent#244](https://github.com/nginx/agent/pull/244)
- Merge release-2.23.3 back into main by [@github](https://github.com/github)-actions in [agent#252](https://github.com/nginx/agent/pull/252)
- Add lineCount support to dirmap files by [@Dean](https://github.com/Dean)-Coakley in [agent#234](https://github.com/nginx/agent/pull/234)
- Add amazonlinux2 arm64 support by [@Dean](https://github.com/Dean)-Coakley in [agent#262](https://github.com/nginx/agent/pull/262)
